...
```      
pip install anndata arboreto cell2location commot karateclub matplotlib networkx numpy pandas phate pot scanpy scipy scvelo scvi-tools seaborn distributed dask-expr
