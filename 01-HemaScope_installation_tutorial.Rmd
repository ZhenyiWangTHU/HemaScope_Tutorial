...
```      
pip install anndata arboreto cell2location commot karateclub matplotlib networkx numpy==1.23.5 pandas==1.5.3 phate pot scanpy scipy scvelo==0.2.5 scvi-tools seaborn distributed radian
