...
<<<<<<< Updated upstream
devtools::install_github(c("hfang-bristol/dnet")) #or using install.packages(pkgs=c("dnet","supraHex"),repos="http://R-Forge.R-project.org", type="source")
=======
...
```      
pip install anndata arboreto cell2location commot karateclub matplotlib networkx numpy==1.23.5 pandas==1.3.5 phate pot scanpy scipy scvelo==0.2.5 scvi-tools seaborn distributed dask-expr radian
