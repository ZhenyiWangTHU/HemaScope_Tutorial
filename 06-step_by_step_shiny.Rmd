...
#Run shiny code
shiny::runApp(app_path,launch.browser = FALSE,host = "xx.xx.xx.xx") #host parameter：Your server IP address
```
...
Choice2:Run shiny on Rstudio web page
