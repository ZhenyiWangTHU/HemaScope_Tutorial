...
Whether_load_previous_results <- FALSE #set TRUE to load the RDS files
...
input.data.dirs = c('home/wangzy/HemaScopeR/Demo/SRR7881399/filtered_feature_bc_matrix',    
                    'home/wangzy/HemaScopeR/Demo/SRR7881400/filtered_feature_bc_matrix',  
                    'home/wangzy/HemaScopeR/Demo/SRR7881401/filtered_feature_bc_matrix',  
                    'home/wangzy/HemaScopeR/Demo/SRR7881402/filtered_feature_bc_matrix',  
                    'home/wangzy/HemaScopeR/Demo/SRR7881403/filtered_feature_bc_matrix'  
...
# To specify cell type orders/colors in step8 (Heterogeneity plot), step9 (the violin plot), step 10 (lineage scores)
ViolinPlot.cellTypeOrders <- NULL # specify the vector like c('cell type A', 'cell type B', ...), or set NULL for random orders
if(is.null(ViolinPlot.cellTypeOrders)){
  ViolinPlot.cellTypeOrders <- unique(sc_object@meta.data$selectLabels)
}

ViolinPlot.cellTypeColors <- NULL # specify the vector like c('color A', 'color B', ...), or set NULL for random colors
...
Step11_GSVA.identify.diff.features <- F
...
run_GSVA(sc_object = sc_object,
         ...
         GSVA.cellTypes.orders = ViolinPlot.cellTypeOrders,
...
```{R, eval=FALSE}
Step12_Construct_Trajectories.clusters <- c('cell.type1','cell.type2','cell.type3',...)
```
```{R, eval=FALSE}
...
```{R, eval=FALSE}
slingshot.start.clus <- "cell.type1"
slingshot.end.clus <- "cell.type2"
